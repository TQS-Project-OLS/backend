...
public class DataInitializer {
    ...
    private void createInstruments() {
        Instrument[] instruments = {
                createInstrument("Yamaha P-125 Digital Piano", "Professional 88-key digital piano with weighted keys",
                        45.0, InstrumentType.DIGITAL, InstrumentFamily.KEYBOARD, 2, 1),
                createInstrument("Fender Stratocaster", "Classic electric guitar with vintage tone", 60.0,
                ...
                createInstrument("Taylor 214ce Acoustic", "Beautiful acoustic guitar with cutaway", 50.0,
                ...
                createInstrument("Yamaha YAS-280 Alto Sax", "Student-level alto saxophone", 55.0, InstrumentType.WIND,
                        InstrumentFamily.WOODWIND, 4, 3),
                createInstrument("Fender Precision Bass", "Classic 4-string electric bass", 55.0, InstrumentType.BASS,
                        InstrumentFamily.GUITAR, 6, 4),
                createInstrument("Korg Minilogue XD", "Polyphonic analog synthesizer", 65.0, InstrumentType.SYNTHESIZER,
                ...
                createInstrument("Pearl Export Drum Kit", "5-piece acoustic drum set", 70.0, InstrumentType.DRUMS,
                ...
                createInstrument("Yamaha YTR-2330 Trumpet", "Student brass trumpet", 48.0, InstrumentType.WIND,
    ...
    private void createMusicSheets() {
        MusicSheet[] sheets = {
                createMusicSheet("Moonlight Sonata", "Ludwig van Beethoven", "Piano solo masterpiece", "CLASSICAL",
                        12.99, "Piano", 15.5f, 1),
                createMusicSheet("Für Elise", "Ludwig van Beethoven", "Popular piano piece", "CLASSICAL", 8.99, "Piano",
                        3.5f, 1),
                createMusicSheet("Canon in D", "Johann Pachelbel", "Beautiful baroque composition", "CLASSICAL", 10.99,
                        "String Ensemble", 5.0f, 2),
                createMusicSheet("Take Five", "Dave Brubeck", "Jazz standard in 5/4 time", "JAZZ", 14.99,
                        "Jazz Quartet", 5.5f, 2),
                createMusicSheet("Autumn Leaves", "Joseph Kosma", "Classic jazz ballad", "JAZZ", 11.99, "Piano/Vocal",
                        4.0f, 3),
                createMusicSheet("Bohemian Rhapsody", "Queen", "Epic rock opera", "ROCK", 16.99, "Full Band", 6.0f, 3),
                createMusicSheet("Stairway to Heaven", "Led Zeppelin", "Legendary rock ballad", "ROCK", 15.99,
                        "Guitar/Band", 8.0f, 4),
                createMusicSheet("Let It Be", "The Beatles", "Timeless pop ballad", "POP", 12.99, "Piano/Vocal", 4.0f,
                        4),
                createMusicSheet("Imagine", "John Lennon", "Iconic peace anthem", "POP", 11.99, "Piano/Vocal", 3.5f, 5),
                createMusicSheet("Sweet Child O' Mine", "Guns N' Roses", "Classic rock anthem", "ROCK", 14.99,
                        "Full Band", 5.5f, 5),
                createMusicSheet("The Entertainer", "Scott Joplin", "Ragtime piano classic", "JAZZ", 9.99, "Piano",
                        4.0f, 6),
                createMusicSheet("Summertime", "George Gershwin", "Jazz standard from Porgy and Bess", "JAZZ", 13.99,
                        "Vocal/Piano", 4.5f, 6),
                createMusicSheet("Nocturne Op. 9 No. 2", "Frédéric Chopin", "Romantic piano nocturne", "CLASSICAL",
                        11.99, "Piano", 5.0f, 7),
                createMusicSheet("The Thrill Is Gone", "B.B. King", "Blues guitar classic", "BLUES", 12.99,
                        "Guitar/Band", 4.5f, 7),
                createMusicSheet("Crossroads", "Robert Johnson", "Delta blues standard", "BLUES", 10.99, "Guitar/Vocal",
                        3.0f, 8)
        };
