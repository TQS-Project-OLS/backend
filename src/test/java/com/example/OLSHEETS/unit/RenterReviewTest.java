...
class RenterReviewTest {
    ...
    void testDefaultConstructor() {
        ...
        assertNotNull(review.getCreatedAt()); // Set in BaseReview constructor
    }

    @Test
    void testParameterizedConstructor() {
        RenterReview review = new RenterReview(booking, 5, "Excellent renter!");
        
        assertNull(review.getId());
        assertEquals(booking, review.getBooking());
        assertEquals(5, review.getScore());
        assertEquals("Excellent renter!", review.getComment());
    ...
    void testSettersAndGetters() {
        ...
        review.setScore(4);
        review.setComment("Good renter");
        
        assertEquals(1L, review.getId());
        assertEquals(booking, review.getBooking());
        assertEquals(4, review.getScore());
        assertEquals("Good renter", review.getComment());
    }

    @Test
    void testScoreValidation_WithValidScore() {
        RenterReview review = new RenterReview(booking, 5, "Great!");
        assertEquals(5, review.getScore());
    ...
    void testCommentCanBeNull() {
        RenterReview review = new RenterReview(booking, 4, null);
        assertNull(review.getComment());
    }

    @Test
    void testCommentCanBeEmpty() {
        RenterReview review = new RenterReview(booking, 4, "");
    ...
    void testCreatedAtIsSetAutomatically() {
        ...
        RenterReview review = new RenterReview(booking, 5, "Great renter!");
